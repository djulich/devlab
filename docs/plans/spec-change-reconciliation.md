...
- Milestones may carry `planning_generation = N`. A milestone is actionable only when its generation matches the current planning generation, unless it is already completed historical work.

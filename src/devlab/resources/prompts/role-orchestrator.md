...
9. If an integrator reports Open Issues, create a finding and route back to the planner; otherwise write an integration marker in archived handoffs.
10. If a planner handoff lists addressed findings, set those finding statuses to `planned`.

...
- Keep modules focused. If logic belongs to an existing abstraction, extend that abstraction instead of duplicating file/path assumptions in unrelated modules.
